	...
	<div class="w">
		...
		<ul class="fr lh">
			...
			<li class="fore2-1 ld" id="jd-vip">
				<s></s>
				<a target="" rel="nofollow" href="">会员俱乐部</a>
			</li>
			...
			<li class="fore4 ld menu" id="biz-service" data-widget="dropdown" clstag="homepage|keycount|home2013|01e">
				...
				<div class="dd">
					...
					<div><a href="" target="" rel="nofollow">售后服务</a></div>
					<div><a href="" target="" rel="nofollow">在线客服</a></div>
					<div><a href="" target="" rel="nofollow">投诉中心</a></div>
					<div><a href="" target="">客服邮箱</a></div>
				</div>
			</li>
			<li class="fore5 ld menu" id="site-nav" data-widget="dropdown" clstag="homepage|keycount|home2013|01f">
				...
				<div class="dd lh">
					<dl class="item fore1">
						<dt>特色栏目</dt>
						<dd>
							<div><a target="" href="">易购通信</a></div>
							<div><a target="" href="">校园之星</a></div>
							<div><a target="" href="">为我推荐</a></div>
							<div><a target="" href="">视频购物</a></div>
							<div><a target="" href="">易购社区</a></div>
							<div><a target="" href="">在线读书</a></div>
							<div><a target="" href="">装机大师</a></div>
							<div><a target="" href="">易购E卡</a></div>
							<div><a target="" href="">家装城</a></div>
							<div><a target="" href="">搭配购</a></div>
							<div><a target="" href="">我喜欢</a></div>
						</dd>
					</dl>
					<dl class="item fore2">
						<dt>企业服务</dt>
						<dd>
							<div><a target="" href="">企业客户</a></div>
							<div><a target="" href="">办公直通车</a></div>
						</dd>
					</dl>
					<dl class="item fore3">
						<dt>旗下网站</dt>
						<dd>
							<div><a target="" href="">English Site</a></div>
						</dd>
					</dl>
				</div>
			</li>
