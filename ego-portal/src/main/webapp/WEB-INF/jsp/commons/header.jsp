		...
		<div id="nav-2013">
			...
			<div id="treasure" clstag="homepage|keycount|home2013|08a"></div>
				<ul id="navitems-2013">
					...
					<li class="fore6" id="nav-shan" clstag="homepage|keycount|home2013|07f"><a href="" >闪购</a></li>
					<li class="fore7" id="nav-jinrong" clstag="homepage|keycount|home2013|07g1"><a href="" >金融</a></li>
				</ul>
		</div>
	</div>
</div>
